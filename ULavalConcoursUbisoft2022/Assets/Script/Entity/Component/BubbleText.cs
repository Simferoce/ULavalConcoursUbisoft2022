...
public class BubbleText : MonoBehaviour
{
    ...
    public static Dictionary<int, Message> messages = new Dictionary<int, Message>()
    {
        ...
        {9, new Message() {Id = 9, Source = Source.Depression, Text = "I'm lonely. Only my thoughts are staying with me.", Duration = 4.0f } },
        ...
        {12, new Message() {Id = 12, Source = Source.Depression, Text = "It's futile to stuggle.", Duration = 4.0f } },
        {13, new Message() {Id = 13, Source = Source.Depression, Text = "Empty. Drained. Tarnished.", Duration = 4.0f } },
