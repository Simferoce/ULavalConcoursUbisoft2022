...
public class BubbleText : MonoBehaviour
{
    ...
    public static Dictionary<int, Message> messages = new Dictionary<int, Message>()
    {
        ...
        {7, new Message() {Id = 7, Source = Source.Depression, Text = "There is nothing to do. Everybody is sick, everything is close.", Duration = 4.0f } },
        {8, new Message() {Id = 8, Source = Source.Depression, Text = "The only thing that have not change is the amount of work.", Duration = 4.0f } },
